...
@Component({
  selector: 'app-external-payment-navbar',
  templateUrl: './external-payment-navbar.component.html',
  styleUrls: ['./external-payment-navbar.component.scss']
})
export class ExternalPaymentNavbarComponent implements OnInit {
