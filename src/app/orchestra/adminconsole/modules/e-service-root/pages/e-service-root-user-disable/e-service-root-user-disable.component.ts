...
import { EServiceRootBaseService } from './../../../e-service-root/services/e-service-root-base.service';
...
@Component({
  selector: 'app-e-service-root-user-disable',
  templateUrl: './e-service-root-user-disable.component.html',
  styleUrls: ['./e-service-root-user-disable.component.scss']
})
export class EServiceRootUserDisableComponent implements OnInit {
  ...
  constructor(
    ...
    private eServiceBase: EServiceRootBaseService) {
  ...
  searchPortalUser(searchText) {
    ...
    this.eServiceBase.postePortalUserSearch(
      {
      ...
      //         this.eServiceBase.postOnlinePaymentsSearchByAccountNo(
      //           {
      ...
      //         this.eServiceBase.getExternalPaymentsSearchByAccountNo(this.applicationList[j].UtilityAccounts[i].AccountNo).subscribe((xpay: any) => {
