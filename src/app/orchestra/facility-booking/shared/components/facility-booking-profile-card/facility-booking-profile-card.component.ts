...
@Component({
  selector: 'app-facility-booking-profile-card',
  templateUrl: './facility-booking-profile-card.component.html',
  styleUrls: ['./facility-booking-profile-card.component.scss']
})
export class FacilityBookingProfileCardComponent implements OnInit {
