...
@Component({
  selector: 'app-dutyroster-hr-create-shift',
  templateUrl: './dutyroster-hr-create-shift.component.html',
  styleUrls: ['./dutyroster-hr-create-shift.component.scss']
})
export class DutyrosterHrCreateShiftComponent implements OnInit {
  ...
  constructor(
    ...
    console.log('this.topButtons - this.topButtons ->', this.topButtons);
  ...
  getAllShiftGroups(pageSize, pageNum) {
    ...
    this.assignedShiftGroups.ShowDeleted = false;
    ...
    this.dutyRosterBase.postShiftGroupsAll(
      {
        'ShowDeleted': this.assignedShiftGroups.ShowDeleted,
  ...
  private setWeekDetailsInTopButton(buttonIndex, weekNo, year) {
    ...
    console.log('setWeekDetailsInTopButton -> buttonIndex', buttonIndex);
    console.log('setWeekDetailsInTopButton -> weekNo', weekNo);
    console.log('setWeekDetailsInTopButton -> year', year);
