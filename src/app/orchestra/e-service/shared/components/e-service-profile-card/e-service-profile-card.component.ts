...
@Component({
  selector: 'app-e-service-profile-card',
  templateUrl: './e-service-profile-card.component.html',
  styleUrls: ['./e-service-profile-card.component.scss']
})
export class EServiceProfileCardComponent implements OnInit {
