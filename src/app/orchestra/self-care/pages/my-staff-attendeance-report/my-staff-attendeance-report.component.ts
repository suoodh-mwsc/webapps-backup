...
@Component({
  selector: 'app-my-staff-attendeance-report',
  templateUrl: './my-staff-attendeance-report.component.html',
  styleUrls: ['./my-staff-attendeance-report.component.scss']
})
export class MyStaffAttendeanceReportComponent implements OnInit {
