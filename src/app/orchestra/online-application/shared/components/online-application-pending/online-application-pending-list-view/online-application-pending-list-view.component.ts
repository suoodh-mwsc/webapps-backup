...
@Component({
  selector: 'app-online-application-pending-list-view',
  templateUrl: './online-application-pending-list-view.component.html',
  styleUrls: ['./online-application-pending-list-view.component.scss']
})
export class OnlineApplicationPendingListViewComponent implements OnInit {
