...
@Component({
  selector: 'app-online-application-profile-card',
  templateUrl: './online-application-profile-card.component.html',
  styleUrls: ['./online-application-profile-card.component.scss']
})
export class OnlineApplicationProfileCardComponent implements OnInit {
