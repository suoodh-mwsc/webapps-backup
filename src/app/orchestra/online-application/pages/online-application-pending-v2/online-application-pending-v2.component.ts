...
@Component({
  selector: 'app-online-application-pending-v2',
  templateUrl: './online-application-pending-v2.component.html',
  styleUrls: ['./online-application-pending-v2.component.scss']
})
export class OnlineApplicationPendingV2Component implements OnInit {
  ...
  getPendingApplications(pageSize, pageNum) {
    ...
    this.onlineAppBase.postUtilityOnlineApplicationsPending(
      ...
      console.log('getPendingApplications- Pagination ->', this.pendingApplicationsPaginationInfo);
      console.log('getPendingApplications -Data ->', this.pendingApplications);
    },
      (error: Response | any) => {
        this.showLoader = false;
  ...
  remarks(selectedOnlineApplication) {
    console.log('Remarks', selectedOnlineApplication);
    this.onlineAppBase.postUtilityOnlineApplicationsMWSCRemarks(
      ...
      console.log('Remarks Response', data);
      // selectedOnlineApplication.CurrentStage = 1;
      // selectedOnlineApplication.CurrentStageDescription = 'Incomplete';
      this.showReject = false;
