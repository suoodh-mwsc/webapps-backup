...
@Component({
  selector: 'app-online-application-pending',
  templateUrl: './online-application-pending.component.html',
  styleUrls: ['./online-application-pending.component.scss']
})
export class OnlineApplicationPendingComponent implements OnInit {
